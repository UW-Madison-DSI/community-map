...
# Database: academic
# Generation Time: 2022-10-18 17:59:39 +0000
# ************************************************************
...
CREATE TABLE `people` (
  ...
  `socialUrl` varchar(256) DEFAULT NULL,
  ...
  `appointmentType` varchar(64) DEFAULT NULL,
  ...
  `researchInterests` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
