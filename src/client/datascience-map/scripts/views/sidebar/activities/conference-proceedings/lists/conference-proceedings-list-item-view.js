/******************************************************************************\
|                                                                              |
|                    conference-proceedings-list-item-view.js                  |
|                                                                              |
|******************************************************************************|
|                                                                              |
...
import ConferenceProceedingDetailsView from '../../../../../views/sidebar/activities/conference-proceedings/lists/conference-proceeding-details-view.js';
...
export default ActivitiesListItemView.extend({
	...
	template: _.template(`
		...
		<td class="name">
			<div class="title">
				<span class="conference-proceeding icon">
	...
	showDetails: function() {
		this.showChildView('details', new ConferenceProceedingDetailsView({
			model: this.model
		}));
	}
});