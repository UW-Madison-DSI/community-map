...
import GrantDetailsView from '../../../../../views/sidebar/activities/grants/lists/grant-details-view.js';
...
export default ActivitiesListItemView.extend({
	...
	showDetails: function() {
		this.showChildView('details', new GrantDetailsView({
			model: this.model
		}));
	}
});