...
export default BaseView.extend({
	...
	<h2>How to put yourself on the map: </h2>
		<p>Note: You will need a valid UW-Madison email address in order to create an account. </p>
		<ol>
			<li>
				<label>Create Your Account</label>
				<ul>
					<li>Click on the “Add Me” button in the upper right corner of the screen. </li>
		...
		<h2>How to find others on the map: </h2>
		<ul>
			<li>
				<label>The Checkbox Filters</label>
		...
		<div class="well">
			Stuck? We're here to help.  Do you have suggestions, questions, or other feedback? <a href="#contact">Contact us.</a>
		</div>
	`)
});
